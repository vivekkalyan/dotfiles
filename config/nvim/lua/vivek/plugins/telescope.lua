return {
  ...
  config = function()
    ...
    keymap.set("n", "<leader>u", "<cmd>Telescope undo<cr>", { desc = "Find string in cwd" })
    ...
    keymap.set("n", "<leader>fF", "<cmd>Telescope find_files { hidden = true, no_ignore = true } <cr>", { desc = "Fuzzy find all files in cwd" })
    keymap.set("n", "<leader>fh", "<cmd>Telescope help_tags<cr>", { desc = "List help tags" })
    keymap.set("n", "<leader>fk", "<cmd>Telescope keymaps<cr>", { desc = "List normal mode kepmaps" })
    ...
    keymap.set("n", "<leader>fG", "<cmd>Telescope git_bcommits<cr>", { desc = "List buffer's git commits" })
